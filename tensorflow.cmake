...
add_custom_target(tflu_gen ALL
                  COMMAND make -j${J} -f ${TFLU_PATH}/tools/make/Makefile microlite TARGET=${TFLU_TARGET} TARGET_ARCH=${TFLU_TARGET_ARCH} CC_TOOL=${TFLU_CC} CXX_TOOL=${TFLU_CXX} AR_TOOL=${TFLU_AR} GENDIR=${TFLU_GENDIR} CMSIS_PATH=${CMSIS_PATH} ETHOSU_DRIVER_PATH=${CORE_DRIVER_PATH} ETHOSU_DRIVER_LIBS=${TFLU_ETHOSU_LIBS} TAGS="${TFLU_TAGS}" BUILD_TYPE=${TFLU_BUILD_TYPE}  $<$<BOOL:${TFLU_DEBUG_OPTIMIZATION}>:DEBUG_DEFAULT_OPTIMIZATION=${TFLU_DEBUG_OPTIMIZATION}> $<$<BOOL:${TFLU_RELEASE_OPTIMIZATION}>:RELEASE_DEFAULT_OPTIMIZATION=${TFLU_RELEASE_OPTIMIZATION}>
